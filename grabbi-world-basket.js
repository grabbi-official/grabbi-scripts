...
(function() {
  ...
  // Only run on world food subpages
  var path = window.location.pathname;
  var worldFoodPages = [
    'indian-grocery','chinese-grocery','filipino-grocery',
    'sri-lankan-grocery','caribbean-grocery','african-grocery',
    'japanese-korean-grocery','middle-eastern-grocery','eastern-european-grocery'
  ];
  var isWorldFoodPage = worldFoodPages.some(function(p){ return path.indexOf(p) !== -1; });
  if (!isWorldFoodPage) return;
